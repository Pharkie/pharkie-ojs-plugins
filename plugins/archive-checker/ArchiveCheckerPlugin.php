...
class ArchiveCheckerPlugin extends GenericPlugin
{
    ...
    public function addReviewCta(string $hookName, array $params): bool
    {
        ...
        $output = &$params[2];
        $output .= '<style>@media (max-width: 768px) { .ac-cta-mobile-note { display: block !important; } }</style>'
            . '<section class="item ac-review-cta">'
        ...
        <div class="ac-help-overlay" x-show="showGuide" x-cloak @click="dismissGuide()"
            ...
            <div class="ac-help-box" @click.stop>
                ...
                <div class="ac-help-action-cards">
                    <div class="ac-help-action-card ac-help-action-problem"><span class="ac-help-action-icon">&#x26A0;</span> <strong>Report / Update Problem</strong> &mdash; describe what's wrong</div>
