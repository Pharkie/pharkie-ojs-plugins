...
WordPress uses [Bedrock](https://roots.io/bedrock/) — Composer manages WP core + plugins, config reads from `.env`. See [WP plugin management](wp-plugin-management.md) for adding/removing plugins.
