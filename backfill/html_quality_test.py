...
SAMPLES = [
    ...
    {
        "label": "v25-editorial",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/25.1/01-editorial.pdf",
        "desc": "Vol 25.1 Editorial (2014, born-digital)",
    },
    {
        "label": "v33-editorial",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/33.2/01-editorial.pdf",
        "desc": "Vol 33.2 Editorial (2022, 2-page)",
    },
    {
        "label": "v26-bookreview-ed",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/26.1/16-book-reviews.pdf",
        "desc": "Vol 26.1 Book Review Editorial (2015, 4 pages)",
    },
    {
        "label": "v30-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/30.1/02-facing-an-uncertain-future-the-next-30-years-of-existential-therapy.pdf",
        "desc": "Vol 30.1 Article (2019, born-digital, 14 pages)",
    },
    {
        "label": "v22-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/22.2/02-de-beauvoir-bridget-jones-pants-and-vaginismus.pdf",
        "desc": "Vol 22.2 Article (2011, medium length)",
    },
    {
        "label": "v10-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/10.1/01-reculer-pour-mieux-sauter.pdf",
        "desc": "Vol 10.1 Article (1999, older format)",
    },
    {
        "label": "v13-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/13.1/02-death-a-philosophical-perspective.pdf",
        "desc": "Vol 13.1 Article (2002, scanned/OCR)",
    },
    {
        "label": "v06-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/6.2/02-husserl-phenomenology-and-psychology.pdf",
        "desc": "Vol 6.2 Article (1995, scanned/OCR)",
    },
    {
        "label": "v37-article",
        "pdf": "/workspaces/wp-ojs-sync/backfill/output/37.1/02-therapy-for-the-revolution-lessons-from-the-front-line.pdf",
